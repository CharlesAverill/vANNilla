class Random:
    def __init__(self, seed=1618033988):
    ...
    def next(self, min_val=0, max_val=1):
        return min_val + (max_val - min_val) * next(self.rng)

    def rand_range(self):
        """
        :return: a generator yielding floats between min_val
                 and max_val, generated by a standard
